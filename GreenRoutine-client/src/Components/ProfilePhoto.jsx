    ...
    return (
      <>
        <Card className='w-100'>
          <CardImg top width="100%" src={userPhoto ? userPhoto : profileImg} alt="Profile photo" onClick={toggle} className='cursor-pointer' />
          <CardBody>
        ...
        <UploadProfilePhotoModal isOpen={displayModal} toggle={toggle} userId={user.id}onPhotoUpload={onPhotoUpload}/>
      </>
    )
}
